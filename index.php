    ...
    <div class="order-box" id="box">
        ...
        <div class="order-main-pane" Id='orderMP'>
            ...
            <form class="second-half-mainpane">
                <table>
                  <tr>
                    <td>
                      ...
                      <input type="text" class="address-box" id="namebox" style="margin-top:5px;font-size:100%">
                    </td>
                    <td>
                      <p style=" font-family: 'Montserrat', cursive;  font-weight:bold">Your Contact No : </p>
                      <input type="text" class="address-box" id="concbox" style="margin-top:5px;font-size:100%">
                    </td>
                  </tr>
                </table>
                ...
                <input type="text" class="address-box" id="addbox" style="margin-top:5px;font-size:100%">
                
                <input type="radio" class="options" id="radiotakeaway" name="TAradio" value="Take away" style="position:static;display:inline">
                <label for="radiotakeaway">Take Away</label>
                <input type="radio" class="options" id="radiohomedel" name="HDradio" value="Home Delivery" style="position:static;display:inline">
